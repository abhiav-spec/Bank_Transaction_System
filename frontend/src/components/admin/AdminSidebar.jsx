...
export default function AdminSidebar({ onLogout, isOpen = false, onClose = () => {} }) {
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-72 border-r border-white/25 bg-white/15 p-4 backdrop-blur-xl transition-transform duration-300 lg:z-auto lg:w-72 lg:translate-x-0 lg:rounded-2xl lg:border lg:shadow-none lg:sticky lg:top-24 lg:h-fit ${
